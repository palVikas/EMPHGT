...
<head>
		...
		<!-- Summernote css -->
		<link rel="stylesheet" type="text/css" href="<?php echo base_url('include/vendors/bower_components/summernote/dist/summernote.css'); ?>">
		
		<!-- switchery CSS -->
		<link rel="stylesheet" type="text/css" href="<?php echo base_url('include/vendors/bower_components/switchery/dist/switchery.min.css'); ?>">
	
		<!-- Custom CSS -->
		<link rel="stylesheet" type="text/css" href="<?php echo base_url('include/dist/css/style.css'); ?>">
		...
		<!-- Jasny-bootstrap CSS -->
		<link rel="stylesheet" type="text/css" href="<?php echo base_url('include/vendors/bower_components/jasny-bootstrap/dist/css/jasny-bootstrap.min.css'); ?>">
	...
	<body>
		...
		<div class="wrapper theme-1-active pimary-color-red">
			...
			<div class="fixed-sidebar-left">
				<ul class="nav navbar-nav side-nav nicescroll-bar">
					...
					<li>
						<a href="javascript:add_customer()"><div class="pull-left"><i class="fas fa-industry mr-20"></i><span class="right-nav-text">Add customer</span></div><div class="pull-right"><span class="label label-warning"></span></div><div class="clearfix"></div></a>
					</li>
					<li>
						<a href="javascript:add_hrm()"><div class="pull-left"><i class="fas fa-industry mr-20"></i><span class="right-nav-text">Add HRM</span></div><div class="pull-right"><span class="label label-warning"></span></div><div class="clearfix"></div></a>
					</li>					
		...
		<script type="text/javascript">
			...
			{
				$.ajax({
					url:"<?php echo base_url('branch/index'); ?>",
					type:"post",
			...
			{
				$.ajax({
					url:"<?php echo base_url('branch/add_customer'); ?>",
					type:"post",
					success:function(result)
					{
			...
			{
				$.ajax({
					url:"<?php echo base_url('branch/add_hrm'); ?>",
					type:"post",
					success:function(result)
					{
						$("#main_content").html(result);
