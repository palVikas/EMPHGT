		...
		<div class="wrapper theme-1-active pimary-color-red">
			...
			<div class="fixed-sidebar-left">
				<ul class="nav navbar-nav side-nav nicescroll-bar">
					...
					<li>
						<a href="javascript:super_adviser();"><div class="pull-left"><i class="fas fa-award mr-20"></i><span class="right-nav-text">Add Customer</span></div><div class="pull-right"><span class="label label-warning"></span></div><div class="clearfix"></div></a>
					</li>
					<li>
