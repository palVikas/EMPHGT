...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 02, 2018 at 12:48 PM
...
(3, 'BARR00000003', 'BARRA BRANCH', '44/12 naubasta kanpur', 5, 5, 5, '69652545', '76956496870', '89076533', '700000', 'billu@12', 'pass', '2018-09-29 00:00:00', 1, 1);
...
INSERT INTO `plan` (`PLAN_ID`, `PLAN_NO`, `PLAN_NAME`, `PLAN_DESCRIPTION`, `PLAN_TYPE_ID`, `COMPANY_ID`) VALUES
(0, 0, 'NULL', '', 4, 1),
(1, 0, 'MCS-1 Years', 'MCS-1 Years', 1, 1),
(2, 0, 'MCS-2 Years', 'MCS-2 Years', 1, 1),
(3, 0, 'MCS-3 Years', 'MCS-3 Years', 1, 1),
(4, 0, 'MCS-5 Years', 'MCS-5 Years', 1, 1),
(5, 0, 'OTCS-NC-1 Years', 'OTCS-NC-1 Years', 2, 1),
(6, 0, 'OTCS-NC-2 Years', 'OTCS-NC-2 Years', 2, 1),
(7, 0, 'OTCS-NC-3 Years', 'OTCS-NC-3 Years', 2, 1),
(8, 0, 'OTCS-NC-4 Years', 'OTCS-NC-4 Years', 2, 1),
(9, 0, 'OTCS-NC-5 Years', 'OTCS-NC-5 Years', 2, 1),
(10, 0, 'OTCS-NC-6 Years', 'OTCS-NC-6 Years', 2, 1),
(11, 0, 'MIS-1 Years', 'MIS-1 Years', 3, 1),
(12, 0, 'MIS-2 Years', 'MIS-2 Years', 3, 1),
(13, 0, 'MIS-3 Years', 'MIS-3 Years', 3, 1),
(14, 0, 'MIS-4 Years', 'MIS-4 Years', 3, 1),
(15, 0, 'MIS-5 Years', 'MIS-5 Years', 3, 1),
(16, 0, 'MIS-6 Years', 'MIS-6 Years', 3, 1);
...
--
-- Table structure for table `plan_bonus`
--

CREATE TABLE `plan_bonus` (
  `PLAN_BONUS_ID` int(10) NOT NULL,
  `PLAN_BONUS_NAME` varchar(100) NOT NULL,
  `PLAN_BONUS_TYPE` int(11) NOT NULL,
  `PLAN_BONUS_AMOUNT` int(11) NOT NULL,
  `PLAN_BONUS_DESCRIPTION` varchar(100) NOT NULL,
  `COMPANY_ID` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `plan_bonus`
--

INSERT INTO `plan_bonus` (`PLAN_BONUS_ID`, `PLAN_BONUS_NAME`, `PLAN_BONUS_TYPE`, `PLAN_BONUS_AMOUNT`, `PLAN_BONUS_DESCRIPTION`, `COMPANY_ID`) VALUES
(1, 'LOYALTY BONUS', 0, 2, 'LOYALTY BONUS', 1),
(2, 'ADDITIONAL MATURITY BONUS', 0, 4, 'ADDITIONAL ', 1);

-- --------------------------------------------------------

--
-- Table structure for table `plan_bonus_emi`
--

CREATE TABLE `plan_bonus_emi` (
  `PLAN_BONUS_EMI_ID` int(11) NOT NULL,
  `PLAN_BONUS_ID` int(11) NOT NULL,
  `PLAN_EMI_ID` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `plan_interest` (`PLAN_INTEREST_ID`, `PLAN_INTEREST_RATE`, `PLAN_INTEREST_TYPE`, `TRANSACTION_DATE`, `PLAN_ID`, `PLAN_INTEREST_STATUS`) VALUES
(1, '11.00', 0, '2018-09-27 00:00:00', 1, 1),
(2, '11.50', 0, '2018-09-27 00:00:00', 2, 1),
(3, '12.00', 0, '2018-09-27 00:00:00', 3, 1),
(4, '12.50', 0, '2018-09-27 00:00:00', 4, 1),
(5, '11.00', 0, '2018-09-27 00:00:00', 5, 1),
(6, '11.50', 0, '0000-00-00 00:00:00', 6, 1),
(7, '12.00', 0, '0000-00-00 00:00:00', 7, 1),
(8, '12.50', 0, '0000-00-00 00:00:00', 8, 1),
(9, '13.00', 0, '0000-00-00 00:00:00', 9, 1),
(10, '13.50', 0, '0000-00-00 00:00:00', 10, 1),
(11, '11.00', 0, '0000-00-00 00:00:00', 11, 1),
(12, '11.50', 0, '0000-00-00 00:00:00', 12, 1),
(13, '12.00', 0, '0000-00-00 00:00:00', 13, 1),
(14, '12.50', 0, '0000-00-00 00:00:00', 14, 1),
(15, '13.00', 0, '0000-00-00 00:00:00', 15, 1),
(16, '13.50', 0, '0000-00-00 00:00:00', 16, 1);
...
INSERT INTO `wallet_balance` (`WALLET_ID`, `WALLET_AMOUNT`, `WALLET_TRANSACTION_METHOD`, `WALLET_TRANSACTION_TIME`, `HRM_ID`, `PLAN_ACTIVATION_ID`, `WALLET_REMARK`) VALUES
(494, '-1000.00', 1, '2018-09-26 11:09:42', 18, 1619870000004, 'Purchase a plan of 1000 Rupees'),
(2750, '1000.00', 1, '2018-09-26 12:50:23', 18, 1619870000004, 'Payment successfull of plan worth rupees 1000'),
(2751, '95.00', 5, '2018-09-26 12:50:23', 12, 1619870000004, 'Multi level commission'),
(2752, '5.00', 5, '2018-09-26 12:50:23', 4, 1619870000004, 'Multi level commission'),
(2753, '5.00', 5, '2018-09-26 12:50:23', 3, 1619870000004, 'Multi level commission'),
(2754, '5.00', 5, '2018-09-26 12:50:23', 2, 1619870000004, 'Multi level commission'),
(2755, '20.00', 5, '2018-09-26 12:50:23', 1, 1619870000004, 'Multi level commission'),
(2792, '-3000.00', 1, '2018-09-27 08:44:43', 20, 1619870000005, 'Purchase a plan of 3000 Rupees'),
(2793, '3000.00', 1, '2018-09-27 08:45:05', 20, 1619870000005, 'Payment successfull of plan worth rupees 3000'),
(2794, '240.00', 5, '2018-09-27 08:45:05', 19, 1619870000005, 'Multi level commission'),
(2795, '45.00', 5, '2018-09-27 08:45:05', 13, 1619870000005, 'Multi level commission'),
(2797, '15.00', 5, '2018-09-27 08:45:05', 4, 1619870000005, 'Multi level commission'),
(2798, '15.00', 5, '2018-09-27 08:45:05', 3, 1619870000005, 'Multi level commission'),
(2799, '15.00', 5, '2018-09-27 08:45:05', 2, 1619870000005, 'Multi level commission'),
(2800, '105.00', 5, '2018-09-27 08:45:05', 1, 1619870000005, 'Multi level commission');
...
--
-- Indexes for table `plan_bonus`
--
ALTER TABLE `plan_bonus`
  ADD PRIMARY KEY (`PLAN_BONUS_ID`),
  ADD KEY `COMPANY_ID` (`COMPANY_ID`);

--
-- Indexes for table `plan_bonus_emi`
--
ALTER TABLE `plan_bonus_emi`
  ADD PRIMARY KEY (`PLAN_BONUS_EMI_ID`),
  ADD KEY `PLAN_BONUS_ID` (`PLAN_BONUS_ID`,`PLAN_EMI_ID`);
...
--
ALTER TABLE `hrm`
  MODIFY `HRM_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT for table `hrm_relation`
--
ALTER TABLE `hrm_relation`
  MODIFY `HRM_RELATION_ID` int(1) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
...
--
ALTER TABLE `nominee`
  MODIFY `NOMINEE_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
-- AUTO_INCREMENT for table `plan_bonus_emi`
--
ALTER TABLE `plan_bonus_emi`
  MODIFY `PLAN_BONUS_EMI_ID` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `plan_interest`
  MODIFY `PLAN_INTEREST_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `wallet_balance`
  MODIFY `WALLET_ID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2801;
...
--
ALTER TABLE `plan`
  ADD CONSTRAINT `plan_ibfk_1` FOREIGN KEY (`COMPANY_ID`) REFERENCES `company` (`COMPANY_ID`),
  ADD CONSTRAINT `plan_plantypeidfk` FOREIGN KEY (`PLAN_TYPE_ID`) REFERENCES `plan_type` (`PLAN_TYPE_ID`);
...
--
-- Constraints for table `plan_bonus`
--
ALTER TABLE `plan_bonus`
  ADD CONSTRAINT `plan_bonus_ibfk_1` FOREIGN KEY (`COMPANY_ID`) REFERENCES `company` (`COMPANY_ID`);

--
-- Constraints for table `plan_emi`
--
ALTER TABLE `plan_emi`
  ADD CONSTRAINT `plan_emi_ibfk_1` FOREIGN KEY (`PLAN_ID`) REFERENCES `plan` (`PLAN_ID`);

--
-- Constraints for table `plan_interest`
--
ALTER TABLE `plan_interest`
  ADD CONSTRAINT `plan_interest_ibfk_1` FOREIGN KEY (`PLAN_ID`) REFERENCES `plan` (`PLAN_ID`);
